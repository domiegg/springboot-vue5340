  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<el-form-item label="工号" class="input" v-if="tableName=='fuwurenyuan'">
			...
			<el-form-item label="确认密码" class="input" v-if="tableName=='fuwurenyuan'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>
			...
			<el-form-item label="员工姓名" class="input" v-if="tableName=='fuwurenyuan'">
			...
			<el-form-item label="联系手机" class="input" v-if="tableName=='fuwurenyuan'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((!this.ruleForm.gonghao) && `fuwurenyuan` == this.tableName){
      ...
      if((!this.ruleForm.xingbie) && `fuwurenyuan` == this.tableName){
        this.$message.error(`性别不能为空`);
        return
      }
      if((!this.ruleForm.youxiang) && `fuwurenyuan` == this.tableName){
        this.$message.error(`邮箱不能为空`);
        return
      }
      ...
      if((!this.ruleForm.lianxishouji) && `fuwurenyuan` == this.tableName){
        this.$message.error(`联系手机不能为空`);
        return
      }
      if(`fuwurenyuan` == this.tableName && this.ruleForm.lianxishouji&&(!this.$validate.isMobile(this.ruleForm.lianxishouji))){
