  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='fuwurenyuan'"  label="工号" prop="gonghao">
          <el-input v-model="ruleForm.gonghao" readonly              placeholder="工号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='fuwurenyuan'"  label="员工姓名" prop="yuangongxingming">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='fuwurenyuan'"  label="联系手机" prop="lianxishouji">
          <el-input v-model="ruleForm.lianxishouji"               placeholder="联系手机" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="24">  
        <el-form-item v-if="flag=='fuwurenyuan'" label="相片" prop="xiangpian">
          <file-upload
          tip="点击上传相片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.xiangpian?ruleForm.xiangpian:''"
          @change="fuwurenyuanxiangpianUploadChange"
          ></file-upload>
        </el-form-item>
      </el-col>
...
export default {
  ...
  methods: {
    ...
    fuwurenyuanxiangpianUploadChange(fileUrls) {
        this.ruleForm.xiangpian = fileUrls;
    },
    onUpdateHandler() {
      ...
      if((!this.ruleForm.gonghao)&& 'fuwurenyuan'==this.flag){
      ...
      if((!this.ruleForm.yuangongxingming)&& 'fuwurenyuan'==this.flag){
        this.$message.error('员工姓名不能为空');
        return
      }
      if((!this.ruleForm.xingbie)&& 'fuwurenyuan'==this.flag){
        this.$message.error('性别不能为空');
        return
      }
      if((!this.ruleForm.youxiang)&& 'fuwurenyuan'==this.flag){
        this.$message.error('邮箱不能为空');
        return
      }
      ...
      if((!this.ruleForm.lianxishouji)&& 'fuwurenyuan'==this.flag){
        this.$message.error('联系手机不能为空');
        return
      }
      if( 'fuwurenyuan' ==this.flag && this.ruleForm.lianxishouji&&(!isMobile(this.ruleForm.lianxishouji))){
