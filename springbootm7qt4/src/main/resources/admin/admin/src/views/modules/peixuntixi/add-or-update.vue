  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.peixuntupian" label="培训图片" prop="peixuntupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.peixuntupian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="师资力量" prop="shizililiang">
          <el-input v-model="ruleForm.shizililiang" 
              placeholder="师资力量" clearable  :readonly="ro.shizililiang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="师资力量" prop="shizililiang">
              <el-input v-model="ruleForm.shizililiang" 
                placeholder="师资力量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.peixunshipin" label="培训视频" prop="peixunshipin">
          <file-upload
          tip="点击上传培训视频"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.peixunshipin?ruleForm.peixunshipin:''"
          @change="peixunshipinUploadChange"
          ></file-upload>
        </el-form-item> 
        <div v-else>
          <el-form-item v-if="ruleForm.peixunshipin" label="培训视频" prop="peixunshipin">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.peixunshipin)">预览</el-button>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="基本流程" prop="jibenliucheng">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="基本流程"
                  v-model="ruleForm.jibenliucheng" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jibenliucheng" label="基本流程" prop="jibenliucheng">
                    <span>{{ruleForm.jibenliucheng}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	faburiqi : false,
      ...
      rules: {
          ...
          jibenliucheng: [
                { required: true, message: '基本流程不能为空', trigger: 'blur' },
          ],
          shizililiang: [
                { required: true, message: '师资力量不能为空', trigger: 'blur' },
          ],
          lianxiren: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.peixuntupian = true;
          ...
          if(o=='jibenliucheng'){
            this.ruleForm.jibenliucheng = obj[o];
	    this.ro.jibenliucheng = true;
            continue;
          }
          if(o=='shizililiang'){
            this.ruleForm.shizililiang = obj[o];
	    this.ro.shizililiang = true;
            continue;
          }
          if(o=='lianxiren'){
	    ...
	    this.ro.lianxifangshi = true;
          ...
          if(o=='peixunshipin'){
            this.ruleForm.peixunshipin = obj[o];
	    this.ro.peixunshipin = true;
            continue;
          }
          if(o=='faburiqi'){
	...
	if(this.ruleForm.peixunshipin!=null) {
		this.ruleForm.peixunshipin = this.ruleForm.peixunshipin.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `peixuntixi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.peixuntixiCrossAddOrUpdateFlag = false;
						 this.parent.search();
    ...
    peixunshipinUploadChange(fileUrls) {
	this.ruleForm.peixunshipin = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
