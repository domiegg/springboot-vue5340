<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="服务进度" prop="fuwujindu">
        ...
        <div v-else>
          <el-form-item class="input" label="服务进度" prop="fuwujindu">
  ...
  data() {
	...
	gengxinshijian : false,
      ...
      rules: {
          ...
          fuwujindu: [
                { required: true, message: '服务进度不能为空', trigger: 'blur' },
          ],
          fuwuneirong: [
